...
import {json, defer, redirect, type LoaderArgs} from '@vercel/remix';
...
export async function loader({request, params}: LoaderArgs) {
  ...
  const customer = await getCustomer(request, customerAccessToken);
  ...
  return defer(
    {
      ...
      featuredData: getFeaturedData(request),
    },
    {
      headers: {
