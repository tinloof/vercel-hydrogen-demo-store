...
export async function cartCreate({
  ...
  const {cartCreate} = await storefrontClient.mutate<{
    cartCreate: {
      cart: CartType;
...
export async function cartAdd({
  ...
  const {cartLinesAdd} = await storefrontClient.mutate<{
    cartLinesAdd: {
      cart: CartType;
      errors: CartUserError[];
    };
...
export async function cartRemove({
  ...
  const {cartLinesRemove} = await storefrontClient.mutate<{
...
export async function cartUpdate({
  ...
  const {cartLinesUpdate} = await storefrontClient.mutate<{
...
export async function cartUpdateBuyerIdentity({
  ...
  const {cartBuyerIdentityUpdate} = await storefrontClient.mutate<{
...
export async function cartDiscountCodesUpdate({
  ...
  const {cartDiscountCodesUpdate} = await storefrontClient.mutate<{
