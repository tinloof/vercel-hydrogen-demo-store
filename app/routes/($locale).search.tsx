import {defer, type LoaderArgs, type SerializeFrom} from '@vercel/remix';
...
export async function getNoResultRecommendations(storefrontClient: Storefront) {
  const {featuredProducts, featuredCollections} = await storefrontClient.query<{
